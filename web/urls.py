...
urlpatterns = patterns('web.views',
    ...
    (r'^holediff/$', 'holediff'),
    (r'^showmembergroupcards/$', 'showmembergroupcards'),
    (r'^holediffdate/$', 'holediffdate'),
    (r'^holediffdaterange/$', 'holediffdaterange'),
    ...
    (r'^managemultitrophies/(?P<trn>\d+)/$', 'managemultitrophies'),
    ...
    (r'^manageteams/(?P<tournid>\d+)/$', 'manageteams'),
    ...
    (r'^addteam/(?P<tournid>\d+)/((?P<id>\d+)/)?$', 'addteam'),
    ...
    (r'^showteamresults/(?P<trp>\d+)/$', 'showteamresults'),
